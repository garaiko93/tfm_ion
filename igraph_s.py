...
# area = 'zermatt'
# areas = ['linthal', 'luzern', 'lugano', 'locarno', 'frutigen', 'stgallen']
areas = ['zurich_kreis']
for area in areas:
    print(area)
...
# num_procs = 32
# test_list = list(g.vs['name'])
# # initializing split index list
# split_list = []
# size = round(len(test_list)/num_procs)
...
#     res_v = res[i]
#     procs.append([threading.Thread(target=straight, args=(nodes_dict, g, res_v))])
#
# for proc in procs:
#     proc[0].start()
# for proc in procs:
